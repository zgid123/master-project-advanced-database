...
export function SubstackCard({ data, index = 0 }: ISubstackCardProps) {
  const { name, description, members, topics, slug } = data;

  return (
    <article
      className='island-shell rise-in flex flex-col overflow-hidden rounded-2xl transition-all hover:border-lagoon/40'
