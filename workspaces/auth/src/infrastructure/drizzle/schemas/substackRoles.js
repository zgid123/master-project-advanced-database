...
export const substackRoles = pgTable('substack_roles', {
    ...baseUuidSchema,
    ...
    return [
        uniqueIndex('substack_roles_substack_id_name_unique').on(table.substackId, table.name),
    ];
});
export const substackRolesRelations = relations(substackRoles, ({ many, one }) => {
    return {
