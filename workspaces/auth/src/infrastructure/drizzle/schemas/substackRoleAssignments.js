...
export const substackRoleAssignments = pgTable('substack_role_assignments', {
    ...baseUuidSchema,
    substackRoleId: uuid()
    ...
    return [
        uniqueIndex('substack_role_assignments_role_id_user_id_unique').on(table.substackRoleId, table.userId),
    ];
});
export const substackRoleAssignmentsRelations = relations(substackRoleAssignments, ({ one }) => {
    return {
