...
export const substacksSubscriptions = pgTable('substacks_subscriptions', {
    ...baseUuidSchema,
    substackId: uuid()
    ...
    return [
        uniqueIndex('substacks_subscriptions_substack_id_user_id_unique').on(table.substackId, table.userId),
    ];
});
export const substacksSubscriptionsRelations = relations(substacksSubscriptions, ({ one }) => {
    return {
