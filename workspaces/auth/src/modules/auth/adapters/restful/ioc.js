import { RefreshTokenCommand, SignInCommand, SignOutCommand, SignUpCommand, SignUserCommand, SubscribeUserCommand, UnsubscribeUserCommand, } from '../../application/portal/v1/commands';
import { GetUserQuery } from '../../application/portal/v1/queries';
import { RoleRepository, UserRepository, UserSubscriptionRepository, } from '../../infrastructure/drizzle/repositories';
...
export function registerAuthIoC({ drizzle }) {
    ...
    const subscribeUserCommand = new SubscribeUserCommand(userRepository, userSubscriptionRepository);
    const unsubscribeUserCommand = new UnsubscribeUserCommand(userRepository, userSubscriptionRepository);
